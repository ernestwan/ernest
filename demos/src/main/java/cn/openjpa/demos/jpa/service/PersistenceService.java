...
public abstract class PersistenceService implements Serializable {
	...
	private static final String DEFAULT_UNIT = "openjpa";
    ...
    public PersistenceService(boolean managed) {
        this.emf = Persistence.createEntityManagerFactory(DEFAULT_UNIT, null);;
